 ...
 */
public class MostSharedTextStatus extends Fragment {
    ...
    private void loadStatusList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.getTextStatus+"category="+Category,
